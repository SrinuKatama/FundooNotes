 ...
 * 
 * @GeneratedValue(strategy = GenerationType.IDENTITY) private long cid;
 * 
 * @Column(name="collabarator_mail") private String email;
 * 
 * 
 ...
 * @ManyToOne
 * 
 * @JoinColumn(name="noteId") private Notes Notes;
 * 
 * 
 * 
 * }
